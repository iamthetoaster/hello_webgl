...
export class RenderClient {
    ...
    static __wrap(ptr) {
        const obj = Object.create(RenderClient.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_renderclient_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.renderclient_new();
        return RenderClient.__wrap(ret);
    }
    /**
    * @param {number} time
    * @param {number} height
    ...
    */
    update(time, height, width) {
        wasm.renderclient_update(this.ptr, time, height, width);
    }
    /**
    */
    render() {
        wasm.renderclient_render(this.ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('hello_webgl_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_clearDepth_6f6539bafb77df29 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_subarray_f2ab17f3c19f7c2a = function(arg0, arg1, arg2) {
